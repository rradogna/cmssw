...
process.standAloneMuons.STATrajBuilderParameters.FilterParameters.EnableGEMCSCMeasurement = cms.bool(True)
process.standAloneMuons.STATrajBuilderParameters.FilterParameters.GEMCSCRecSegmentLabel = cms.InputTag("gemcscSegments","","STARECO")
...
process.standAloneMuons.STATrajBuilderParameters.DoBackwardFilter.EnableGEMCSCMeasurement = cms.bool(True)
process.standAloneMuons.STATrajBuilderParameters.DoBackwardFilter.GEMCSCRecSegmentLabel = cms.InputTag("gemcscSegments","","STARECO")
process.standAloneMuons.STATrajBuilderParameters.DoBackwardFilter.EnableCSCMeasurement = cms.bool(False)
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string( 
                 'file:/lustre/cms/store/user/radogna/GEMCSCSegment/FullDigi_withNewSSegm/out_rec_gemcsc_Xdof_STAGLB_xcommit.test100_cut0p00.root',
    )
)
...
process.p    = cms.Path(process.gemcscSegments * process.standAloneMuons * process.globalMuons)
