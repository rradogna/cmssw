    ...
    if(rechits.size()!=0){
        ...
        for(unsigned int i = 0; i < rechits.size(); ++i) {
            ...
            if (rechits[i]->gemId().layer()==1){
                ...
                float DR_l1 = (theta_ext-theta_rh)*(theta_ext-theta_rh)+(phi_ext-phi_rh)*(phi_ext-phi_rh);
            ...
            if (rechits[i]->gemId().layer()==2){
                ...
                float DR_l2 = (theta_ext-theta_rh)*(theta_ext-theta_rh)+(phi_ext-phi_rh)*(phi_ext-phi_rh);
        ...
        bool DRRequirementOK_l1 = DR_min_l1 < dRChainBoxMax;
        
        if(phiRequirementOK_l1 && thetaRequirementOK_l1 && DRRequirementOK_l1){
        ...
        bool DRRequirementOK_l2 = DR_min_l2 < dRChainBoxMax;
        
        if(phiRequirementOK_l2 && thetaRequirementOK_l2 && DRRequirementOK_l2){
...
void GEMCSCSegAlgoRR::fillChiSquared() {
  ...
  std::cout<<"chi "<<protoChi2<<" protp NDF "<<protoNDF<<std::endl;
